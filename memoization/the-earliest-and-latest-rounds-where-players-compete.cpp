...
public:
    ...
    vector<int> earliestAndLatest(int n, int firstPlayer, int secondPlayer) {
        // Resize to fit bounds: [0, n][0, n][0, n]
        F.assign(n + 1, vector<vector<int>>(n + 1, vector<int>(n + 1, 0)));
        G.assign(n + 1, vector<vector<int>>(n + 1, vector<int>(n + 1, 0)));
